...
function checkWinner(avgDolphins, avgKoalas) {
    if (avgDolphins >= 2 * avgKoalas) {
        console.log(`Đội Dolphins thắng (${avgDolphins.toFixed(2)} vs. ${avgKoalas.toFixed(2)})`);
    } else if (avgKoalas >= 2 * avgDolphins) {
        console.log(`Đội Koalas thắng (${avgKoalas.toFixed(2)} vs. ${avgDolphins.toFixed(2)})`);
    } else {
...
const dolphinsAverage2 = calculateAverage(dolphinsScores2);
const koalasAverage2 = calculateAverage(koalasScores2);
