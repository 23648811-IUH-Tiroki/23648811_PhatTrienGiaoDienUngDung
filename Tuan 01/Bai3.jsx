...
console.log("Điểm trung bình của đội Dolphins:", dolphinsAverage.toFixed(2));
console.log("Điểm trung bình của đội Koala:", koalasAverage.toFixed(2));

if (dolphinsAverage >= 100 || koalasAverage >= 100) {
    if (dolphinsAverage > koalasAverage && dolphinsAverage >= 100) {
        console.log("Đội Dolphins chiến thắng!");
    } else if (koalasAverage > dolphinsAverage && koalasAverage >= 100) {
        console.log("Đội Koala chiến thắng!");
    } else if (dolphinsAverage === koalasAverage && dolphinsAverage >= 100 && koalasAverage >= 100) {
        console.log("Hai đội hòa và cùng đạt điểm tối thiểu!");
    } else {
